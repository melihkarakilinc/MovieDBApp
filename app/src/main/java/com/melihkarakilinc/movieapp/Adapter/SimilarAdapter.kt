...
import com.melihkarakilinc.movieapp.Utils.ApiUrl
...
class SimilarAdapter() : RecyclerView.Adapter<SimilarViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SimilarViewHolder, position: Int) {
        ...
        util.imageLoader(ApiUrl.POSTER_PATH + movie.poster_path, holder.binding.imgPosterSimilar)
...
class SimilarViewHolder(val binding: SimilarLayoutBinding) :
